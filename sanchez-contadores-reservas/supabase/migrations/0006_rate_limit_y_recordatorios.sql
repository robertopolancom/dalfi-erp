...
revoke all on function consumir_rate_limit(text, integer, integer) from public, anon, authenticated;
...
revoke all on function reservas_para_recordatorio(integer) from public, anon;
grant execute on function reservas_para_recordatorio(integer) to authenticated;
