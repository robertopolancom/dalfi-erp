...
--
-- Todo el modelo vive en el esquema `public` de Supabase. La lógica de negocio
-- se implementa en migraciones posteriores como funciones SQL; este archivo solo
-- define estructura, restricciones e índices.
