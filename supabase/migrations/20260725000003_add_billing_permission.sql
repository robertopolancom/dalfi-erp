-- Segundo paso de la separacion gradual de permisos por dominio.
...
set can_manage_billing = can_manage_invoices
where can_manage_billing is distinct from can_manage_invoices;
...
comment on column public.erp_user_profiles.can_manage_billing is
  'Permite crear y administrar facturas, cobros y cuentas por cobrar.';
