-- Quinto paso de la separacion gradual de permisos por dominio.
-- can_review_accounts permanece estrictamente de lectura.
...
set can_manage_accounts = can_manage_invoices
where can_manage_accounts is distinct from can_manage_invoices;
...
comment on column public.erp_user_profiles.can_manage_accounts is
  'Permite escribir cuentas, egresos, transferencias, procesadores y cuentas por pagar; no equivale a can_review_accounts.';
