-- Tercer paso de la separacion gradual de permisos por dominio.
...
set can_manage_inventory = can_manage_invoices
where can_manage_inventory is distinct from can_manage_invoices;
...
comment on column public.erp_user_profiles.can_manage_inventory is
  'Permite administrar existencias, compras, almacenes, activos y auditorias de inventario.';
